    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('uf', models.CharField(help_text='Estado do Grupo Escoteiro.', max_length=2, verbose_name='UF', choices=[(b'RS', 'Rio Grande do Sul'), (b'AC', 'Acre'), (b'AL', 'Alagoas'), (b'AP', 'Amap\xe1'), (b'AM', 'Amazonas'), (b'BA', 'Bahia'), (b'CE', 'Cear\xe1'), (b'DF', 'Distrito Federal'), (b'ES', 'Esp\xedrito Santo'), (b'GO', 'Goi\xe1s'), (b'MA', 'Maranh\xe3o'), (b'MT', 'Mato Grosso'), (b'MS', 'Mato Grosso do Sul'), (b'MG', 'Minas Gerais'), (b'PA', 'Par\xe1'), (b'PB', 'Para\xedba'), (b'PR', 'Paran\xe1'), (b'PE', 'Pernambuco'), (b'PI', 'Piau\xed'), (b'RJ', 'Rio de Janeiro'), (b'RN', 'Rio Grande do Norte'), (b'RO', 'Rond\xf4nia'), (b'RR', 'Roraima'), (b'SC', 'Santa Catarina'), (b'SP', 'S\xe3o Paulo'), (b'SE', 'Sergipe'), (b'TO', 'Tocantins')])),
