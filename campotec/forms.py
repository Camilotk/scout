...
class HomepageForm(ModelForm):
    ...
    btn_save_show_example = forms.CharField(label='', widget=LinkButton(label=_(u"Visualizar Página"),
            attrs={'class':'btn btn-info', 'target':'_blank', 'disabled': 'disabled', 'style': "width: auto;"}),
    ...
    class Meta:
        ...
        fields = ['homepage_active', 'btn_save_show_example', 'homepage_logo', 'homepage_title',
            'homepage_image_background', 'information_active', 'information_title', 'information_text', 'local_active',
            'local_maps_name', 'local_title', 'local_text', 'observation_active', 'observation_title', 'observation_text',]

    def __init__(self, *args, **kwargs):
        super(HomepageForm, self).__init__(*args, **kwargs)

        print("ATTRS:", self.instance.id)
